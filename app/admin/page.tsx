        ...
        <main className="p-4 sm:p-6 lg:p-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href="/admin/posts/new" className="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors dark:bg-blue-900/20 dark:hover:bg-blue-900/30">
