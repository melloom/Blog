    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl lg:text-2xl text-white max-w-3xl mx-auto mb-8 dark:text-white">
            22 • East Coast raised • Solo developer building dope things with tech
          </p>
          <div className="flex flex-wrap justify-center gap-4 text-sm text-white dark:text-white">
          ...
          <section>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="prose prose-lg max-w-none text-white leading-relaxed space-y-6 dark:text-white dark:prose-invert">
                  <p>
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white dark:text-white">Building like a squad, moving like a team</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white dark:text-white">Mastermind with AI as my teammate</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white dark:text-white">If I can automate it, it's already done</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 dark:bg-gray-800 dark:border-gray-700">
                ...
                <p className="text-white mb-4 dark:text-white">Social tools, caption generators, and smart automation that actually understand what users need.</p>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 dark:bg-gray-800 dark:border-gray-700">
                ...
                <p className="text-white mb-4 dark:text-white">Systems that actually work and scale, built for real businesses with real needs.</p>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 dark:bg-gray-800 dark:border-gray-700">
                ...
                <p className="text-white mb-4 dark:text-white">Design that pops and actually works. No fluff, just clean, functional interfaces.</p>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 dark:bg-gray-800 dark:border-gray-700">
                ...
                <p className="text-white mb-4 dark:text-white">Making things faster and smarter. If it can be automated, I'll find a way.</p>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 dark:bg-gray-800 dark:border-gray-700">
                ...
                <p className="text-white mb-4 dark:text-white">Native and cross-platform solutions that users actually want to use.</p>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 dark:bg-gray-800 dark:border-gray-700">
                ...
                <p className="text-white mb-4 dark:text-white">Data-driven insights that actually help businesses grow and scale.</p>
                <div className="flex flex-wrap gap-2">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 dark:bg-gray-800 dark:border-gray-700">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-gray-100">Supabase</h3>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 dark:bg-gray-800 dark:border-gray-700">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-gray-100">Firebase</h3>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 dark:bg-gray-800 dark:border-gray-700">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-gray-100">Stripe</h3>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 dark:bg-gray-800 dark:border-gray-700">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-gray-100">AI/ML</h3>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 dark:bg-gray-800 dark:border-gray-700">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-gray-100">TypeScript</h3>
              </div>
            </div>
          </section>
